...
![](seurat-tutorial_files/figure-html/PCA-1.png)<!-- -->
...
![](seurat-tutorial_files/figure-html/find clusters and visualize-1.png)<!-- -->
...
![](seurat-tutorial_files/figure-html/show AIBS cell types on UMAP-1.png)<!-- -->
...
![](seurat-tutorial_files/figure-html/find markers for all groups-1.png)<!-- -->
...
![](seurat-tutorial_files/figure-html/find markers for SST cells-1.png)<!-- -->
...
![](seurat-tutorial_files/figure-html/find markers for SST cells-2.png)<!-- -->
